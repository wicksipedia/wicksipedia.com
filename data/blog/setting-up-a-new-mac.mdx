...
summary: 'Set up your new Mac for success with this curated list of tools and apps. Begin with Homebrew for installations, explore productivity boosters, and discover utilities that streamline your workflow. Enhance your MacOS experience with efficiency and ease.'
cover: /static/blog/optimizing-new-mac-setup/cover.png
...
![Gordon bought a mac](/static/blog/optimizing-new-mac-setup/gordon-bought-a-mac.png)

I got a teams message from Gordon, later that night he wanted some advice on setting it up and what to install.

![Chat conversation saying that cataloging something to a url is better than random chat messages](/static/blog/optimizing-new-mac-setup/make-a-post.png)
...
- [Oh My Zsh](https://ohmyz.sh/) - An open source, community-driven framework for managing your Zsh configuration, providing themes and plugins to enhance your terminal experience. You can configure your prompt just like Oh My Posh, with all the cool stats and powerline glyphs.
  ...
  ![Preview of the Spaceship theme in Oh my zsh](/static/blog/optimizing-new-mac-setup/omz-spaceship.gif)
...
- [Camtasia](https://www.techsmith.com/video-editor.html) - A comprehensive screen recorder and video editor that allows you to create professional-looking videos, ideal for tutorials, presentations, and online courses.
  ```shell
...
- [Rider](https://www.jetbrains.com/rider/) - A fast and powerful cross-platform .NET IDE by JetBrains, which provides an extensive set of features for .NET developers, including robust C# analysis, testing tools, and Docker integration.
...
- [Microsoft Azure Storage Explorer](https://azure.microsoft.com/en-us/features/storage-explorer/) - A powerful standalone app from Microsoft that enables you to easily work with Azure Storage data on Windows, macOS, and Linux.

  ```shell
  brew install --cask microsoft-azure-storage-explorer
  ```

- [Postman](https://www.postman.com/) - A comprehensive tool for API development, Postman streamlines the testing, documentation, and sharing of APIs, facilitating a more efficient and collaborative workflow for developers.
  ```shell
