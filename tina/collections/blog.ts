...
// Blog posts live as `src/data/blog/{slug}/index.mdx` with colocated images.
// Tina indexes each `index.mdx`; the slug is the parent folder, derived in the
// router below (not the literal `index` filename).
