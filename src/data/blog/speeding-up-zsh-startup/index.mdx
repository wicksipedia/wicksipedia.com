...
After migrating to Zinit, I cleaned up the old Antigen cache. If you're setting up a new Mac and want to start fresh with this optimized setup, check out my [Mac setup guide](/blog/setting-up-a-new-mac) for the complete list of tools to install.
