...
ogImage: /blog/speeding-up-zsh-startup/cover.png
...
After migrating to Zinit, I cleaned up the old Antigen cache. If you're setting up a new Mac and want to start fresh with this faster setup, check out my [Mac setup guide](/blog/setting-up-a-new-mac) for the complete list of tools to install.
...
**Update:** The setup has evolved since this post. I've since added Starship, fnm, zoxide, Atuin, and a few other tools. See [my current Zsh setup](/blog/modern-zsh-setup) for the full config.
