...
You'll need a passphrase for the PGP key - I recommend using a password manager to generate and store (I use [1Password](https://1password.com/))
...
Go to [Github - SSH and GPG Keys](https://github.com/settings/keys) and:
