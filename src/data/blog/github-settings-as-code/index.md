...
ogImage: /blog/github-settings-as-code/config-as-code.png
tags:
  - GitHub
  - git
---
...
Thankfully Probot has a better approach to this dilemma. We update a file stored in the repo (`.github/settings.yml`). After committing and pushing the file, the [Probot Settings app](https://probot.github.io/apps/settings/) kicks in and makes sure that the repository settings match what the file says.
...
This approach pairs really well with trunk-based development. If you're struggling with environment branches causing merge conflicts and deployment confusion, check out my post on [the downfalls of environment branching patterns](/blog/downfalls-of-environment-branching-patterns) to see why a simpler branching strategy works better.
...
To take your GitHub security even further, consider [signing your commits with GPG](/blog/verifying-your-github-commits) so that team members can verify that commits actually came from you.
