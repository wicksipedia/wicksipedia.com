...
ogImage: /blog/downfalls-of-environment-branching-patterns/cover.png
featured: false
draft: false
tags:
  - CI/CD
...
- The merge commits made it hard to tell what had been merged back and what hadn't. This would make it hard to know what was deployed to each environment. Understanding [how git diffs work](/blog/git-and-diffs) really helps when untangling these kinds of situations.

## Let's get... stuff done

Done - Issue raised with the client, email sent with recommendations.

It was time to roll up my sleeves and dig into the actual task at hand — tweaking their deployment pipeline as initially requested. I got into it, made the necessary changes, and got the Pull Requests (PRs) merged into the respective branches. It felt like a well-earned victory, albeit a small one in the grand scheme of things.
...
With this simpler flow, I also helped them set up [GitHub repository settings as code](/blog/github-settings-as-code) so branch protection rules could be managed via a YAML file, and showed them how to [sign their commits with GPG](/blog/verifying-your-github-commits) to ensure code authenticity.
